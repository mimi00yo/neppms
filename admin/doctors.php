...
?>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $spcil_name=$spcil_array["sname"];
            $tele=$row['doctel'];
            $start_time=$row['doc_start_time'];
            $end_time=$row['doc_end_time'];
            $profile_image = $row['profile_image'];
            $avatar_url = !empty($profile_image) ? '../' . $profile_image : '../img/user.png';
            echo '
            <div id="popup1" class="overlay">
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <img src="'.$avatar_url.'" alt="Profile" style="width:100px; height:100px; border-radius:12px; object-fit:cover; margin-bottom:15px;"><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                '.date('h:i A', strtotime($start_time)).' - '.date('h:i A', strtotime($end_time)).'<br><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            ';
                ...
                $errorlist= array(
                    ...
                    '5'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Invalid Telephone Number. Please use Nepal mobile format (98XXXXXXXX or 97XXXXXXXX).</label>',
                    '4'=>"",
                    '0'=>'',
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="Tele" class="input-text" placeholder="Telephone Number (98XXXXXXXX)" pattern="(98|97)[0-9]{8}" title="Please enter a valid Nepal mobile number (10 digits starting with 98 or 97)" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="max_tokens" class="form-label">Max Tokens Per Day: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="max_tokens" class="input-text" placeholder="Default: 20" value="20" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="slot_duration" class="form-label">Slot Duration (Mins): </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="slot_duration" class="input-text" placeholder="Default: 15" value="15" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="start_time" class="form-label">Starting Time (Work Hours): </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="start_time" class="input-text" value="09:00" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="end_time" class="form-label">Ending Time (Work Hours): </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="end_time" class="input-text" value="17:00" required><br>
                                </td>
                            </tr>
        ...
        ';
            ...
            $start_time=$row['doc_start_time'];
            $end_time=$row['doc_end_time'];
            $max_tokens=$row['doc_max_tokens'];
            $slot_duration=$row['doc_slot_duration'];
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="display:flex; align-items:center; gap:20px; margin-bottom: 20px;">
                                                <img src="'.$avatar_url.'" alt="Profile" style="width:80px; height:80px; border-radius:12px; object-fit:cover;">
                                                <div>
                                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Doctor Details.</p>
                                                    <span style="color:#666;">Doctor ID : '.$id.' (Auto Generated)</span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="edit-doc.php" method="POST" enctype="multipart/form-data" class="add-new-form">
                                            <label for="Email" class="form-label">Email: </label>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" placeholder="Telephone Number (98XXXXXXXX)" value="'.$tele.'" pattern="(98|97)[0-9]{8}" title="Please enter a valid Nepal mobile number (10 digits starting with 98 or 97)" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="number" name="max_tokens" class="input-text" value="'.$max_tokens.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="number" name="slot_duration" class="input-text" value="'.$slot_duration.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="time" name="start_time" class="input-text" value="'.$start_time.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="time" name="end_time" class="input-text" value="'.$end_time.'" required><br>
                                        </td>
                                    </tr>
                                        <td class="label-td" colspan="2">
                                            <label for="profile_image" class="form-label">Profile Photo (Optional): </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="file" name="profile_image" accept="image/*" class="input-text" style="padding:6px;"><br>
                                            <small style="color:#888;">JPG, PNG, GIF or WebP &bull; Max 3 MB &bull; Leave blank to keep current</small><br><br>
                                        </td>
                                    </tr>
