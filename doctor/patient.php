            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Visit History: </label>
                                </td>
                            </tr>
                            <tr>
                            <td colspan="2">
                                ...
                                <table width="100%" class="sub-table" border="0">
                                    <thead>
                                        <tr>
                                            <th class="table-headin" style="font-size: 12px;">Session Title</th>
                                            <th class="table-headin" style="font-size: 12px;">Appo. No.</th>
                                            <th class="table-headin" style="font-size: 12px;">Date</th>
                                        </tr>
                                    </thead>
                                    <tbody>';
                                        
                                            $history_res = $database->query("select schedule.title, appointment.apponum, schedule.scheduledate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid where appointment.pid='$id' and schedule.docid='$userid' order by schedule.scheduledate desc");
                                            if($history_res->num_rows==0){
                                                echo '<tr><td colspan="3" style="text-align:center;padding:10px;font-size:12px;color:#888;">No visit history found.</td></tr>';
                                            }else{
                                                while($hrow=$history_res->fetch_assoc()){
                                                    echo '<tr>
                                                        <td style="font-size:12px;">'.substr($hrow["title"],0,30).'</td>
