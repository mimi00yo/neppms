...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "SELECT doctor.* FROM doctor INNER JOIN specialties ON doctor.specialties=specialties.id WHERE docemail='$keyword' or docname='$keyword' or docname like '$keyword%' or docname like '%$keyword' or docname like '%$keyword%' or sname like '%$keyword%'";
                    }else{
